...
const getProductThemeColors = (theme: string) => {
    ...
    switch (theme) {
        case 'sky':
            return { accentText: 'text-sky-400', tagBg: 'bg-sky-900/50' };
        case 'cyan':
            return { accentText: 'text-cyan-400', tagBg: 'bg-cyan-900/50' };
        case 'teal':
            return { accentText: 'text-teal-400', tagBg: 'bg-teal-900/50' };
        case 'purple':
            return { accentText: 'text-purple-400', tagBg: 'bg-purple-900/50' };
        case 'rose':
            return { accentText: 'text-rose-400', tagBg: 'bg-rose-900/50' };
        case 'red':
            return { accentText: 'text-red-400', tagBg: 'bg-red-900/50' };
        case 'lime':
            return { accentText: 'text-lime-400', tagBg: 'bg-lime-900/50' };
        case 'violet':
            return { accentText: 'text-violet-400', tagBg: 'bg-violet-900/50' };
        case 'amber':
            return { accentText: 'text-amber-400', tagBg: 'bg-amber-900/50' };
        case 'indigo':
            return { accentText: 'text-indigo-400', tagBg: 'bg-indigo-900/50' };
        case 'fuchsia':
            return { accentText: 'text-fuchsia-400', tagBg: 'bg-fuchsia-900/50' };
        case 'orange':
            return { accentText: 'text-orange-400', tagBg: 'bg-orange-900/50' };
        case 'slate':
            return { accentText: 'text-slate-400', tagBg: 'bg-slate-800/50' };
        case 'emerald':
            return { accentText: 'text-emerald-400', tagBg: 'bg-emerald-900/50' };
        case 'stone':
            return { accentText: 'text-stone-400', tagBg: 'bg-stone-800/50' };
        default:
            return { accentText: 'text-accent', tagBg: 'bg-accent/10' }; // Fallback to main gold accent
    }
};
        ...
        <section id="cosmetics" ref={sectionRef} className="py-16 sm:py-24 bg-surface">
            <div className="container mx-auto px-4">
                ...
                <div className={`max-w-7xl mx-auto transition-all duration-700 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '400ms' }}>
                    {activeTabData && (
                         <div key={activeTabData.id} className="cosmetic-content p-4 sm:p-6 bg-primary rounded-3xl fade-in-content">
